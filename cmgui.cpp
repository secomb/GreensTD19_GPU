/************************************************************************
cmgui - for GreensTD.  TWS December 2011.
3D visualization of networks. 
Based on code provided by Gib Bogle. Produces greens.exelem and greens.exnode
...
void cmgui(float *segvar)
{
	...
	FILE *exelem,*exnode;
	exelem = fopen("greens.exelem","w");
	exnode = fopen("greens.exnode","w");
